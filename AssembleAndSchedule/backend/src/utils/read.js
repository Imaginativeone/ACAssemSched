        ...
        // console.log (counter + "  " + res + " " + spider); // to help see line numbers inorder to locate data indexes
            ...
            if (resList.length > 19){
                ...
                try {
                    ...
                    console.log(counter + " " + lineProj(proj_no) + " " + lineProj(customizedItem) + " " + lineProj(sort1) + " " + spider)
                    counter++;
                    spider++;
                    return lineProj                
                } catch (err){
                    console.err("There was an error creating file data", JSON.stringify(err));
                    return res.send(err);
                }
            }
     });
