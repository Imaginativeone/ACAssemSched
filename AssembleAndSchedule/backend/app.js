...
import assemdb from "./src/database";
import AssemFile from "./models/assemFile";
import AssemFileData from "./config/assemFileData";

assemdb.sequelize.sync(function (err) {
